    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className="flex flex-col gap-4 flex-1">
                ...
                p-3 rounded-lg' id='address'  required />  
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <span className='font-normal text-grey-600 ml-2'> The first image
                ...
                <p className='text-red-700 text-sm'>{imageUploadError && imageUploadError}</p>
                  {
                    ...
                    formData.imageUrls.map((url,index)=>(
                        ...
                        hover:opacity-70'>Delete</button>
                        </div>
                        ))
                  }
              <button className='p-3 bg-slate-700 text-white rounded-lg uppercase
              hover:opacity-95 disabled:opacity-60'>Create Listing</button>
            </div>
        </form>
    </main>
  )
